...
const dict: Record<Lang, Record<string, DictValue>> = {
  en: {
    ...
    panelKickerMyCanvases: "Library",
    panelKickerAccount: "Account",
    panelKickerQuickActions: "Shortcuts",
    panelKickerWorkspace: "Workspace",
    homeBrandKicker: "Product",
    myCanvases: "My Canvases",
    loadingList: "Loading list...",
    emptyCanvases: "No canvas yet. Click New Canvas to start.",
    homeHeroKicker: "Overview",
  ...
  zh: {
    ...
    cloud: "云端",
    local: (p) => `本地 ${p?.usage ?? ""}`,
    panelKickerMyCanvases: "画布库",
    panelKickerAccount: "账户",
    panelKickerQuickActions: "快捷方式",
    panelKickerWorkspace: "工作台",
    homeBrandKicker: "产品",
    myCanvases: "我的画布",
    loadingList: "加载列表...",
